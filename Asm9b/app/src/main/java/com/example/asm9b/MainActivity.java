    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if ((urlEditText.getText().length() == 0) && (searchEditText.getText().length() == 0)) {
                    ...
                    result.setText("The search phrase appears: "+ count +" times.");
                }
            }
        });
    }
        ...
        try {
            ...
            if(inputStream !=null) {
                ...
                while ((charRead = inputStreamReader.read(inputBuffer)) > 0) {
                    ...
                    //content+=readString;
                    selectedIndex = readString.indexOf(searchPhrase);
                    if ((selectedIndex!= -1) && !(searchPhrase.equals(""))) {
                        count++;
                    }
